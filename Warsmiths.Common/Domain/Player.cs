...
namespace Warsmiths.Common.Domain
{
    public class Player : IEntity
    {
        ...
        public Player(string login, string password, string firstname, string lastname,
        ...
        public bool IsPlayerHasEquipment(string id, bool searchInCharactersWearingEquipments = true)
        {
            ...
            if (searchInCharactersWearingEquipments)
            {
                if (Characters != null)
                {
                    ...
                    foreach (var currentPlayerCharacter in Characters)
                    {
                        var characterEquipment = TryGetEquipmentFromCharacterEquipments<object>(currentPlayerCharacter, id);
        ...
        public T TryGetEquipmentFromCharacterEquipments<T>(Character character, string equipmentId)
        {
            ...
            if (character.Equipment.Armor != null && character.Equipment.Armor._id == equipmentId) characterEquipment = character.Equipment.Armor;
            else if (character.Equipment.RightWeapon != null && character.Equipment.RightWeapon._id == equipmentId) characterEquipment = character.Equipment.RightWeapon;
            else if (character.Equipment.LeftWeapon != null && character.Equipment.LeftWeapon._id == equipmentId) characterEquipment = character.Equipment.LeftWeapon;
