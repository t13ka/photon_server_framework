...
namespace YourGame.Client.ChatApi
{
    ...
    public interface IChatClientListener
    {
        ...
        ///     channelName for private messages (messages you sent yourself get added to a channel per
        ///     target username)
        /// </param>
        ...
        /// <param name="gotMessage">
        ///     True if the status contains a message you should cache locally. False: This status update does
        ///     not include a message (keep any you have).
        /// </param>
