...
{
    /// <summary>
    ///     Wraps up codes for parameters (in operations and events) used internally in Photon Chat. You don't have to use them
    ///     directly usually.
    /// </summary>
    public class ChatParameterCode
    {
        ...
        /// <summary>
        ///     (14) Number of message to fetch from history. 0: no history. 1 and higher: number of messages in history. -1:
        ///     all history.
        /// </summary>
        ...
        /// <remarks>The code is used in LoadBalancing and copied over here.</remarks>
        ...
        /// <summary>(225) Name of user to send a (private) message to.</summary>
        /// <remarks>The code is used in LoadBalancing and copied over here.</remarks>
