...
namespace Warsmiths.Client.Loadbalancing
{
    ...
    public class Player
    {
        ...
        /// </summary>
        /// <remarks>
        /// The ID is assigned per room and only valid in that context. 
        /// It will change even on leave and re-join. IDs are never re-used per room.
        /// </remarks>
        public int ID
        {
            get { return actorID; }
        ...
        /// Synced automatically in a room and used as fallback-UserId, if that wasn't set.
        /// </summary>
        /// <remarks>
        ...
        public string NickName
        {
            ...
            set
            {
                ...
                if (IsLocal && LoadBalancingClient != null &&
                    LoadBalancingClient.State == ClientState.Joined)
                {
        ...
        public Hashtable AllProperties
        {
            get
            {
                ...
                allProps.Merge(CustomProperties);
                allProps[ActorProperties.PlayerName] = nickName;
                return allProps;
            }
        }

        /// <summary>
        /// Custom object associated with this Player. 
        /// Not synchronized!
        /// </summary>
        public object Tag;

        /// <summary>
        /// In turnbased games, other players might be inactive in a room. 
        /// True when another player is not in the current room.
        /// </summary>
        public bool IsInactive ; //TURNBASED
        ...
        public Player GetNextFor(int currentPlayerId)
        {
            ...
            var players = RoomReference.Players;
            var nextHigherId = int.MaxValue; // we look for the next higher ID
            var lowestId = currentPlayerId;
                // if we are the player with the highest ID, there is no higher and we return to the lowest player's id
        ...
        {
            var pp = p as Player;
            return (pp != null && GetHashCode() == pp.GetHashCode());
        }
        ...
        {
            var properties = new Hashtable {[ActorProperties.PlayerName] = nickName};
            this.LoadBalancingClient.OpSetPropertiesOfActor(ID, properties);
        }
    }
}