...
namespace Warsmiths.Server.Services.DomainConfig
{
    public class ConfigChangeListenerService : IRuntimeService, IDisposable
    {
        ...
        {
            const string fn = "..\\..\\..\\NewClient\\Assets\\StreamingAssets\\Data\\Craft\\Reciepts\\Admar\\Reciepts.txt";
        ...
        private void CheckAndInstallDefaultConfiguration()
        {
            ...
            if (currentConfig == null)
            {
                ...
                Log.DebugFormat("<<<< ================ THE NEW DOMAIN CONFIGURATION INSTALLED TO DATABASE ================ >>>");
            ...
            {
                Log.DebugFormat("<<<< ================ THE DOMAIN CONFIGURATION HAS BEEN EXTRACTED FROM DATABASE ================ >>>");
